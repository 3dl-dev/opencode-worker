...
> **Skill provenance.** Cross-compiled from the canonical source for one target.
> - Cross-compiled for: model `qwen3.8-27b`, agent `opencode`, environment `local opencode serve`
